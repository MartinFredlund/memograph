...
7. [x] Image detail endpoint — `GET /api/images/{uid}` (single image with full details: tags with coordinates, event, place, caption)
8. [x] Image metadata update endpoint — `PUT /api/images/{uid}` (update caption, taken_date)
